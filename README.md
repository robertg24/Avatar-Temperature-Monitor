...
The way to physcially calibrate it would be to use three temperatures, ranging across the entirety of the curve in Figure 1. Some easy temperatures to use would be ice water, room temperature water, and boiling water, noting the resistances for each instance. Once you have these values you can do some matrix math and solve for the three coefficients. For this case, I used [this website](extension://bfdogplmndidlpjfhoijckpakkdjkkil/pdf/viewer.html?file=https%3A%2F%2Fwww.thinksrs.com%2Fdownloads%2Fpdfs%2Fapplicationnotes%2FLDC%2520Note%25204%2520NTC%2520Calculator.pdf) which did all that for me, although it used different temperatures.
